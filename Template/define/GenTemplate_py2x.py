...
# 并将其生成.cs和.xml
#
#运行环境：python 2.x  (python 3.x可以使用 GenTemplate.py)
#
#Author：王飞飞
#Time：2018-11
#
...
OutFilePath_Xml = r"E:\Unity2017Work\GameFrameWork\Data\Proto\OutPut"
...
def GenerateXml(className, classValue):
    ...
    for kv in classValue:
        ...
        key.text = (classValue[kv]["comment"]).encode('utf-8')
    ...
    if os.path.isfile(out_file):
        ...
        f_entries = f_root.findall('entry')
